...
- [ ] Read [TA Guide](https://github.com/advanced-computing/course-materials/blob/main/docs/ta_guide.md).
- [ ] Set up office hours in [the shared calendar](https://github.com/advanced-computing/course-materials?tab=readme-ov-file#meeting-datestimes).
- [ ] Do [the same one-time setup the students do](https://github.com/advanced-computing/course-materials/blob/main/readings/week_02.md#one-time-setup).
