...
| Week | Lecure date | Lecture topic(s)                                                  | Assignments due (at the start of lecture)                                 | [Lab](labs/) topic(s)                                    | [Lab](labs/) due (at the start of the Lab sesion) |
| ---- | ----------- | ----------------------------------------------------------------- | ------------------------------------------------------------------------- | -------------------------------------------------------- | ------------------------------------------------- |
| 1    | 1/23        | [Welcome; collaborating on code (GitHub)](lectures/lecture_01.md) | none                                                                      | [Computer setup; Git workflow](labs/lab_01.md)           | none                                              |
| 2    | 1/30        | [Project/product management](lectures/lecture_02.md)              | [Readings](readings/week_02.md)                                           | [Jupyter/pandas/visualization refresher](labs/lab_02.md) | none                                              |
...
| 6    | 2/27        | [Organizing code](lectures/lecture_06.md)                         | [Readings](readings/week_06.md), [Project Part 3](docs/project.md#part-3) | [Google Cloud setup](labs/lab_06.md)                     | [Lab 5](labs/lab_05.md)                           |
| 7    | 3/6         | Databases                                                         | [Readings](readings/week_07.md)                                           | TBD                                                      | [Lab 6](labs/lab_06.md)                           |
| 8    | 3/13        | [Data engineering (pipelines, ETL)](lectures/lecture_08.md)       | [Readings](readings/week_08.md), [Project Part 4](docs/project.md#part-4) | TBD                                                      | TBD                                               |
| 9    | 3/20        | none ([Spring Recess][recess])                                    | none                                                                      | none ([Spring Recess][recess])                           | none                                              |
| 10   | 3/27        | Infrastructure / cloud computing                                  | [Readings](readings/week_10.md)                                           | TBD                                                      | TBD                                               |
| 11   | 4/3         | Big data; algorithms                                              | [Readings](readings/week_11.md)                                           | TBD                                                      | TBD                                               |
| 12   | 4/10        | Privacy                                                           | [Readings](readings/week_12.md)                                           | TBD                                                      | TBD                                               |
| 13   | 4/17        | buffer                                                            | [Readings](readings/week_13.md)                                           | TBD                                                      | TBD                                               |
